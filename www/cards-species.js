...
(function (global) {
  ...
  var CSS = [
    ...
    '.obs.card-md > li > .name > .spprimary, .obs.xl > li > .name > .spprimary {',
    '  grid-column: 3; grid-row: 1; align-self: center; justify-self: end;',
    '  padding-left: 10px; }',
    '.spmetricstack { display: grid; gap: 5px; text-align: right;',
    '  font-variant-numeric: tabular-nums; }',
    '.spmetric { display: inline-flex; align-items: baseline; justify-content: flex-end;',
    '  gap: 4px; color: var(--muted); text-decoration: none;',
    '  line-height: 1; white-space: nowrap; }',
    '.spmetric strong { font-size: calc(15px * var(--s)); font-weight: 800; }',
    '.spmetric small { margin-top: 1px; font-size: calc(10px * var(--s));',
    '  font-weight: 700; color: var(--muted); }',
    '.spmetricstack > .spmetric:first-child strong {',
